    ...
    public partial class DataBase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        OderId = c.Int(nullable: false, identity: true),
                        ProductId = c.Int(nullable: false),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Quantity = c.Int(nullable: false),
                        Oder_Id = c.Int(),
                    })
                .PrimaryKey(t => t.OderId)
                .ForeignKey("dbo.tbl_Oder", t => t.Oder_Id)
                ...
                c => new
                    {
                        ...
                        Adderss = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tbl_OderDetail", "ProductId", "dbo.tbl_Product");
            DropForeignKey("dbo.tbl_Product", "ProductCategoryId", "dbo.tbl_ProductCategory");
            DropForeignKey("dbo.tbl_OderDetail", "Oder_Id", "dbo.tbl_Oder");
            ...
            DropIndex("dbo.tbl_OderDetail", new[] { "Oder_Id" });
            DropIndex("dbo.tbl_OderDetail", new[] { "ProductId" });
            ...
            DropTable("dbo.tbl_Oder");
            DropTable("dbo.tbl_OderDetail");
